...
public abstract class HNamedWidget extends HWidget {
     ...
     * @param name the title of the widget
     */
    public HNamedWidget(Size minimumSize) {
     ...
     * @param name        the title of the widget
     */
    public HNamedWidget(Size minimumSize, Text name) {
     ...
     */
    public HNamedWidget(Text name, double widgetAlignment, double textAlignment, int color) {
     ...
     * @param color           the color to draw the title
     */
    public HNamedWidget(Size minimumSize, Text name, double widgetAlignment, double textAlignment, int color) {
        super(minimumSize);
        this.name = name;
    ...
    public void paint(MatrixStack matrices, int x, int y, int width, int height, int mouseX, int mouseY) {
        if (drawTitle) {
            HDrawing.drawString(matrices, name, (int)(x + width * widgetAlignment), y+4, textAlignment, color);
        }
    }
     ...
     */
    public HNamedWidget doTitle(boolean drawTitle) {
